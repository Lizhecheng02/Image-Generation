...
class Diffusion:
    ...
    def noise_images(self, x, t):
        ...
        sqrt_one_minus_aplha_hat = torch.sqrt(
            1 - self.alpha_hat[t])[:, None, None, None]
        E = torch.randn_like(x)
        return sqrt_alpha_hat * x + sqrt_one_minus_aplha_hat * E, E
...
def launch():
    ...
    args.batch_size = 1
    args.image_size = 64
    args.dataset_path = r"C:\Users\86183\Desktop\Lzc\Data Science\Image Generation\Diffusion\Diffusion Model Pytorch\dataset\landscape dataset"
    args.device = 'cpu'
    args.lr = 3e-4
    train(args)
